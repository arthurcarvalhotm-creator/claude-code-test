...
window.CAFE_DB = (function () {
  ...
  const moedoresModelo = [
    ...
    { id: 'kingrinder-k2', nome: 'Kingrinder K2', tipo: 'manual', min: 0, max: 160, passo: 1, direcao: 'menor=fino',
    ...
    { id: '1zpresso-jx-pro', nome: '1Zpresso JX-Pro', tipo: 'manual', min: 0, max: 200, passo: 1, direcao: 'menor=fino',
